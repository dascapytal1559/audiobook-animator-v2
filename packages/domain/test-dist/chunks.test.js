...
import { computeChunks, listSentenceBreaks, retimeChunks } from "./chunks.js";
const word = (id, value, startSample, endSample) => ({ kind: "word", id, value, startSample, endSample });
const punctuation = (value) => ({ kind: "punctuation", value });
const summary = (chunks) => chunks.map(c => [c.id, c.text, c.breakReason, c.startSample, c.endSample, [...c.wordIds]]);
