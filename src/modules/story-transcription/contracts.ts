...
export const StoryTranscript = Schema.Struct({
  ...
  audio: Schema.Struct({ sha256: Sha256, sampleRateHz: Positive, sampleCount: Positive, sourceStartSample: NonNegative }),
  ...
  elements: Schema.Array(Schema.Union([
    Schema.Struct({ kind: Schema.Literal("word"), id: Text, value: Text, startSample: NonNegative, endSample: NonNegative }),
