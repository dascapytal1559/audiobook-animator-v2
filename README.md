...
| `story-map.json` | agents and scripts | The story map (A62): subjects and sections as word-id ranges, pinned to the clip; reference images it names live inside the story directory. Read by the explorer and `story map`. |
